...
public class Task_13thJune_Increment_Decrement_Operator {
    ...
    public static void main(String[] args) {
        ...
        int a = 5;
        int b = a++;
        // Dry run : value of a gets incremented after assignment to b , so value of b is 5 and value of a is 6
        ...
        int i = 1;
        i = i++ + ++i;
        // Dry run : i= 1 + 3 --->now i value increments to 2 and then to 3, so final value of i is 4
